...
class CapabilityTest(unittest.TestCase):
    def testOutput(self):
        ...
        capability = cap.Capability('./testModules', 0, prepare_sdo, integrity, False, True,
                                    '../parseAndPopulate/test0/')
        capability.parse_and_dump_sdo('../parseAndPopulate/test0/')
        prepare_sdo.dump_sdo_module('../parseAndPopulate/test0/')
