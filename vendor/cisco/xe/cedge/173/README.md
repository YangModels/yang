...
- [YANG Models and Platform Capabilities for Cisco Cedge 17.3](#yang-models-and-platform-capabilities-for-cisco-cedge-173)
  - [Compliance With "pyang --lint"](#compliance-with-pyang---lint)
  - [Revision Statements](#revision-statements)

<!-- END doctoc generated TOC please keep comment here to allow auto update -->

## YANG Models and Platform Capabilities for Cisco Cedge 17.3

This directory contains the YANG models supported by Cedge 17.3:
