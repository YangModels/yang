## YANG Models and Platform Capabilities for Cisco NX-OS 7.0(3)F1(1)

The YANG files in this directory detail the native YANG model supported by NX-OS 7.0(3)F1(1) release.
...
The RPMs supporting YANG models are available for download at the Cisco Artifactory http://devhub.cisco.com/artifactory/open-nxos-agents/7.0-3-F1-1/.
