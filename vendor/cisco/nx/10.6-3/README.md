## YANG Models and Platform Capabilities for Cisco NX-OS 10.6(3)

The YANG files in this directory detail the native and OpenConfig YANG models with deviations supported by NX-OS 10.6(3) release.
