...
to_check="draft/802 draft/802.1 draft/802.1/ABcu draft/802.1/CBcv draft/802.1/CBdb draft/802.1/Qcw draft/802.1/QRev draft/802.1/Qcz draft/802.3 published/1906.1 published/802 published/802.1"
...
checkDir() {
    ...
    exit_status=""
    pyang_flags="--verbose --path $ietf_dir_flag --path $cwd/$ieee_dir/published/802 --path $cwd/$ieee_dir/published/802.1"
    cd $dir
